...
/**
 * Muestra las inscripciones indicadas por el id_actividad
 */
...
public class VerInscripcionActividad extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			request.setAttribute("inscripciones", modRec.getInscripcionActividad(request.getParameter("NombreActividad")));
