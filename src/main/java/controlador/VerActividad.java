...
/**
 * Selecciona actividades segun id_actividad e id_empleado
 */
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if((Integer) session.getAttribute("id_empleado")==null) {
				...
				try {
					request.setAttribute("actividades", modMon.getActividades(request.getParameter("idActividad"),(Integer)session.getAttribute("id_empleado")));
